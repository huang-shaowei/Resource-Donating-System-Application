...
public class OrganizationDirectory {
    ...
    public Organization createOrganization(Organization.Type type){
        ...
        if (type.getValue().equals(Organization.Type.CommunityCenter.getValue())){
            organization = new CommunityCenterOrganization();
        ...
        else if (type.getValue().equals(Organization.Type.Supermarket.getValue())){
            organization = new SupermarketOrganization();
            organizationList.add(organization);
        }
        else if (type.getValue().equals(Organization.Type.Recipient.getValue())){
            organization = new RecipientOrganization();
            organizationList.add(organization);
        }
        else if (type.getValue().equals(Organization.Type.Food.getValue())){
